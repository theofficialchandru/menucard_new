...
#         if search_query:
#             properties = properties.filter(username=search_query)
        
#         registered_hotels_count = properties.count()
#         registered_hotels_count = properties.objects.count()
